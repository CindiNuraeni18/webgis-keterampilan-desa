    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div>
                    <h3 class="mb-1">
                        Detail Wilayah RT {{ $rt->nomor_rt }}
                    </h3>

                    <p class="text-muted mb-0">
                        Informasi warga dan keterampilan yang terdata pada wilayah RT ini
                    </p>
                </div>
            ...
            @php
                ...
                $totalSkill = $rt->wargas->flatMap(fn($w) => $w->keterampilans)->count();

                $kategoriTerbanyak = $rt->wargas
                ...
                if ($kategoriTerbanyak && $kategoriTerbanyak->count()) {
