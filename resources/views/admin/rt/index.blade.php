    ...
    <div class="card border-0 shadow-sm fade-in">
        <div class="card-body">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
                <div>
                    <h4 class="mb-1 title-animate">Data RT</h4>
                    <p class="text-muted title-animate mb-0">Kelola data RT berdasarkan RW dan dusun</p>
                </div>

                <div class="d-flex flex-wrap gap-2">
                    <form action="{{ route('admin.rt.index') }}" method="GET" class="search-wrapper search-animate">
                        <div class="input-group search-group shadow-sm">
                            ...
                            <input type="text" name="search" class="form-control border-0"
                                placeholder="Cari RT / RW / dusun..." value="{{ request('search') }}">
                    ...
                    <a href="{{ route('admin.rt.create') }}" class="btn btn-primary btn-animate click-animate">
                            ...
                            <tr>
                                ...
                                <td class="text-center sticky-col">
                                    <div class="d-flex justify-content-center gap-2">
                                        <a href="{{ route('admin.rt.show', $rt->id) }}" class="btn btn-info btn-sm"
                                            title="Detail">
                                            <i class="bi bi-eye"></i>
                                        </a>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center text-muted">
                                    <i class="bi bi-inbox"></i> Data RT belum ada.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
